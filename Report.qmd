...
Pod względem skuteczności najlepszy wynik osiągnął model lasu losowego, z dokładnością 95.25%, drugi w kolejności wynik to model boosting, z dokładnością 94.4%, natomiast ostatni, chociaż nadal wysoki rezultat to dokładność 93.09% dla modelu bagging.
