...
Zbiór danych Credit Card Churn Prediction pochodzi z serwisu Kaggle [@Credit_Card_Churn_Prediction]. Zawiera informacje o 10127 klientach banku, dla których na podstawie 19 zmiennych określono fakt posiadania karty kredytowej - jest to 20 zmienna w zbiorze.
...
Metody te podzieliłem na trzy zestawy, w zależności od zalecanego preprocessingu[^1], powstaną zatem trzy przepływy pracy.
...
Wyniki dwóch najlepszych modeli porównam za pomocą zbioru testowego. Na początku pobieram najlepsze zestawy parametrów ze względu na metrykę zbalansowanej dokładności.
...
Oba modele na zbiorze testowym dają bardzo podobne wyniki predykcji. Na poziomie zbalansowanej dokładności bliskim 0.95 skuteczność obu modeli można ocenić jako bardzo dobrą. Co (pod względem biznesowym) ważne, oba modele lepiej radzą sobie z przewidywaniem klientów, którzy rezygnują z posiadania karty kredytowej.

## Istotność predyktorów

Modele Boostingu i Lasu Losowego porównam pod względem dziesięciu najistotniejszych predyktorów. 
