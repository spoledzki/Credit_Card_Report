...
#| label: fig-Customer_Age_Atr
#| fig-cap: Rozkład wieku klientów według statusu klienta
...
hchart(
  ...
  type = "area", name = "Klient utracony"
) %>%
  hc_add_series(density(plot_data[plot_data$Attrition_Flag == "Klient aktywny", ]$Customer_Age), type = "area", name = "Klient aktywny") %>%
  hc_xAxis(title = list(text = "Wiek klientów")) %>%
  hc_yAxis(title = list(text = "Gęstość")) %>%
  hc_legend(
    title = list(text = "Status klienta"),
